# Generated by Django 6.0 on 2025-12-18 08:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Администратор'), ('EDITOR', 'Редактор'), ('CONTENT_MANAGER', 'Контент-менеджер'), ('VIEWER', 'Наблюдатель')], default='VIEWER', max_length=20, verbose_name='роль')),
